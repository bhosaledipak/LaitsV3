...
define([
    ...
    return declare(null, {
        ...
        _initHandles:function(){
            ...
            var equationLabelWidget = dom.byId("equationLabel");
            on(equationLabelWidget,'Change', lang.hitch(this, function(){
                return this._model.getName(this.handleInputs(equationLabelWidget),this);
